> 由于原作者 github.com/gaobobo/EduCoder_OperationSys 不再更新，本人将基于其项目进行持续补充

# 操作系统头歌快捷通关脚本

本项目提供shell脚本，将脚本复制到终端运行后即可快速通关。

本项目不检查任何来自Gitee的Issue。如果你从Gitee访问本项目，可能不是最新的副本。前往本项目的[Github主页](https://github.com/TheEastIsleStoker/EduCoder_OperationSys)获取最新的更新。
...
clear
# 使用Gitee站点镜像：
wget -O /tmp/{LevelCode}.sh https://gitee.com/TheEastIsleStoker/EduCoder_OperationSys/raw/main/Scripts/{LevelCode}/{LevelCode}.sh
chmod +x /tmp/{LevelCode}.sh
/tmp/{LevelCode}.sh Gitee
```
