...
# 课后作业4.1（第3关）：sys_pause 时的 CS、DS 及其段基址

DownloadSite=${1:-Gitee}
readonly DownloadSite

TaskName="4.1.kehou-3"
TmpDir="/tmp/${TaskName}"
...
case ${DownloadSite} in
  Gitee)
    ...
    download_file "${BaseUrl}/第五关.txt" "${TmpDir}/第五关.txt"
...
mv -f "${TmpDir}/第五关.txt" "/data/workspace/myshixun/第五关.txt"
mv -f "${TmpDir}/gdb.log" "/root/gdb.log"
mv -f "${TmpDir}/dbg.log" "/root/dbg.log"

echo "Checking generated files..."
ls -l "/data/workspace/myshixun/第五关.txt" "/root/gdb.log" "/root/dbg.log"
